...
VERSION=20220830
################################### HARDENING SCRIPT FOR UBUNTU 2204 ########################### 
...
It is based on CIS Ubuntu Linux 22.04 LTS Benchmark v1.0.0 - 08-30-2022 from www.cisecurity.org
...
NO=1.1.2.1;     W=1; S=1; E=; SC=;  BD='Configure /tmp'
lev && (
    check_fstab /tmp
...
NO=1.1.9;    W=2; S=1; E=; SC=;  BD='Disable Automounting'
lev && (remove_package autofs) || systemctl stop autofs && systemctl mask autofs
